   ...
   function __construct()
    ...
    public function index()
    {
        ...
        if ($role_id <= 3) {
           ...
           ->leftJoin('users','users.id','=','uppd_main_menu.user_id')
           ->select('uppd_main_menu.*','users.name')
           ->where('uppd_main_menu.role_id',$role_id)
           ->orderBy('order','asc')
           ->get();
        } 
    ...
    public function create()
    {
        ...
        $parent_uppd = DB::table('uppd_main_menu')
        ->where('role_id','=',$role_id)
        ->where('jenis_konten','=',0)
        ->get();
        // echo json_encode($role);
        // dd($role);
        return view('uppd.mainmenu.create',compact('parent','rs','iduser','role_id','parent_uppd'));
    ...
    public function edit($id)
    {
        ...
        return view('uppd.mainmenu.edit',compact('main','parent','jenis','iduser','role_id','parent_uppd'));
    }
