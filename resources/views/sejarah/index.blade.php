  ...
  <div class="row layout-spacing">
      ...
      <div class="col-lg-12">
          ...
          <div class="statbox widget box box-shadow">
            <a class="btn btn-success" href="{{ route('sotksejarah.create') }}"> Create New</a>
              <div class="widget-content widget-content-area">
                  <table id="zero-config" class="table style-3  table-hover">
                      ...
                      <tbody id="tablecontents">
                        @foreach ($sejarah as $key => $al)
                            <tr  id="tr_{{$al->id}}" class="row1" data-id="{{ $al->id }}">
                                <td ><input type="checkbox" class="sub_chk" data-id="{{$al->id}}">   </td>
                                <td>{{ $al->nama }}</td>
                                <td>{{ $al->tahun_awal }}</td>
                                <td>{{ $al->tahun_akhir }}</td>
                                <td><img src="{{ url('packages/upload/sejarah/'.$al->photo) }}" alt="" height="70px" width="55px"> </td>
                                <td>
                                    @if ($al->flag == 1)
                                ...
                                <td >
                                            ...
                                            <a class="btn btn-primary btn-sm" href="{{ route('sotksejarah.edit',$al->id) }}">Edit</a>
                          ...
                          <div id="rotateleftModal{{ $al->id }}" class="modal animated rotateInDownLeft custo-rotateInDownLeft" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                     <form action="{{ route('sotksejarah.destroy',$al->id) }}" method="POST">
