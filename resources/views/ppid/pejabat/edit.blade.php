    ...
    <div class="row layout-top-spacing">
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                   {!! Form::model($pejabat, ['method' => 'PATCH','route' => ['pejabatppid.update', $pejabat->id],'enctype'=>'multipart/form-data']) !!}
                        {{ Form::hidden('id') }}
                        ...
                        <a class="mt-4 mb-4 btn btn-secondary" href="{{ route('pejabatppid.index') }}"> Back</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
