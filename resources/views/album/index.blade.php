          ...
          <div class="statbox widget box box-shadow">
            ...
            @endcan
              <div class="widget-content widget-content-area">
                        ...
                        @foreach ($album as $key => $al)
                            <tr  id="tr_{{$al->id}}" class="row1" data-id="{{ $al->id }}">
                                ...
                                <td >
                                    ...
                                    <a class="btn btn-primary btn-sm" href="{{ route('album.edit',$al->id) }}">Edit</a>
                                     ...
                                     <form action="{{ route('album.destroy',$al->id) }}" method="POST">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <p class="modal-text">Anda yakin ingin menghapus album {{ $al->album }}</p>
                                            </div>
                                            <div class="modal-footer md-button">
                                                <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                                                @csrf
                                                @method('DELETE')
                                                @can('mod-album-delete')
                  ...
                  <button style="display: none" id="btndlt" class="btn btn-warning btn-sm delete_all" data-url="{{ url('album-multidel') }}">Hapus data</button>
                  {{-- {!! $data->render() !!} --}}
              </div>
          </div>
      </div>
