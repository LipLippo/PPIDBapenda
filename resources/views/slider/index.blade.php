          ...
          <div class="statbox widget box box-shadow">
            <a class="btn btn-success" href="{{ route('sliders.create') }}"> Create New Slider</a>
              <div class="widget-content widget-content-area">
                      ...
                      <tbody id="tablecontents">
                        @foreach ($slider as $key => $al)
                            <tr id="tr_{{$al->id}}" class="row1" data-id="{{ $al->id }}">
                                ...
                                <td><img src="{{ url('packages/upload/slider/'.$al->img ) }}" alt="" height="50px" width="50px"></td>
                                <td>{{ $al->order }}</td>
                                <td>
                                ...
                                <td >
                                    ...
                                    <a class="btn btn-primary btn-sm" href="{{ route('sliders.edit',$al->id) }}">Edit</a>
                          ...
                          <div id="rotateleftModal{{ $al->id }}" class="modal animated rotateInDownLeft custo-rotateInDownLeft" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                     <form action="{{ route('sliders.destroy',$al->id) }}" method="POST">
                  ...
                  <button style="display: none" id="btndlt" class="btn btn-warning btn-sm delete_all" data-url="{{ url('slider-multidel') }}">Hapus data</button>
                  {{-- {!! $data->render() !!} --}}
              </div>
          </div>
      </div>
