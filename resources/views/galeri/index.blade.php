  ...
  <div class="row layout-spacing">
      ...
      <div class="col-lg-12">
          ...
          <div class="statbox widget box box-shadow">
            <a class="btn btn-success" href="{{ route('galeris.create') }}"> Create New Galery</a>
              <div class="widget-content widget-content-area">
                  <table id="zero-config" class="table style-3  table-hover">
                        ...
                        @foreach ($galeri as $key => $al)
                            <tr id="tr_{{$al->id}}" class="row1" data-id="{{ $al->id }}">
                                ...
                                <td >
                                    ...
                                    <a class="btn btn-primary btn-sm" href="{{ route('galeris.edit',$al->id) }}">Edit</a>
                          ...
                          <div id="rotateleftModal{{ $al->id }}" class="modal animated rotateInDownLeft custo-rotateInDownLeft" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                     <form action="{{ route('galeris.destroy',$al->id) }}" method="POST">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <p class="modal-text">Anda yakin ingin menghapus galeri {{ $al->album }}</p>
                                            </div>
                                            <div class="modal-footer md-button">
                                                <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                                                @csrf
                                                @method('DELETE')
                                                @can('mod-galeri-delete')
                   ...
                   <button style="display: none" id="btndlt" class="btn btn-warning btn-sm delete_all" data-url="{{ url('galeri-multidel') }}">Hapus data</button>
                  {{-- {!! $data->render() !!} --}}
              </div>
          </div>
      </div>
