            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item">
                    <a href="{{ route('login') }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-in mr-1"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path><polyline points="10 17 15 12 10 7"></polyline><line x1="15" y1="12" x2="3" y2="12"></line></svg>
                        Login
                    </a>
                </li>
                @endauth
            ...
            <nav id="sidebar">
                ...
                {{----------------------------------ADMIN WEB---------------------------}}
                   ...
                   <!---->
                    ...
                    <li class="menu">
                        <a href="#datatables" data-active="{{ Request::is('mainppid','sliderppid','sotkppid','pejabatppid','permohonan-informasi','admin/ppid/kategori','admin/ppid/kategori/*') ? 'true':''; }}" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled {{ Request::is('mainppid','mainppid/create','sliderppid','sliderppid/create','sotkppid','sotkppid/create','pejabatppid','pejabatppid/create','permohonan-informasi','admin/ppid/kategori','admin/ppid/kategori/*') ? 'show':''; }}" id="datatables" data-parent="#accordionExample">
                             <li  class="{{ Request::is('permohonan-informasi','permohonan-informasi/create') ? 'active':''; }}">
                                <a href="{{ route('permohonan-informasi.index') }}"> Permohonan <br>Informasi</a>
                            </li>
                            ...
                            <li  class="{{ Request::is('admin/ppid/kategori','admin/ppid/kategori/*') ? 'active':''; }}">
                                <a href="{{ route('admin.ppid.kategori.index') }}"> Kategori Informasi </a>
                            </li>
...
<script>
    ...
    // 
    var f3 = flatpickr(document.getElementById('dateFlatpickr'), {
    enableTime: true,
    dateFormat: "Y-m-d H:i",
    });
</script>
