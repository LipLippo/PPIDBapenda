                ...
                <div class="artikel-isi">                    
                    <table class="table table-striped table-hover table-condensed table-bordered datatablejs">
                        ...
                        <tbody>
                            <?php
                                $x = 0;
                                $rschart = \DB::table('statistik_perizinan')->orderBy('tanggal', 'desc')->get();
                            ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{url()}}/statistik_perizinan/{{$item->id}}" class="btn btn-sm btn-default"><i class="fa fa-bar-chart-o"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
