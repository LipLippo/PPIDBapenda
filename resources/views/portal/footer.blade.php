            ...
            <div class="row">
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Privacy policy</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Sosial Media</h4>
                    <ul>
                      <li class="text-white"><i class="bx bx-chevron-right"></i> <a class="text-white" href="https://www.facebook.com/104784660898422?ref=embed_page" target="_blank">Facebook</a></li>
                      <li class="text-white"><i class="bx bx-chevron-right"></i> <a class="text-white" href="https://www.instagram.com/bapenda_jateng" target="_blank">Instagram</a></li>
                      <li class="text-white"><i class="bx bx-chevron-right"></i> <a class="text-white" href="https://twitter.com/BPPD_Jateng?ref_src=twsrc%5Etfw" target="_blank">Twitter</a></li>
                      <li class="text-white"><i class="bx bx-chevron-right"></i> <a class="text-white" href="https://www.tiktok.com/@bapenda.jateng" target="_blank">Tiktok</a></li>
                    </ul>
                </div>
