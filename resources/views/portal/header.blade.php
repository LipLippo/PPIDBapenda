...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('portal/css/prettyPhoto.css') }}" media="screen"
        charset="utf-8" />
    <link rel="stylesheet" type="text/css" href="{{ url('portal/plugin/camera/css/camera.css') }}" media="screen"
        charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('portal/plugin/smartmenu/jquery.smartmenus.bootstrap.css') }}"
...
<body>
            ...
            <div class="modal-dialog modal-md">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" style="margin-top: -16px; font-size: 28px;"
    ...
    <!-- ======= Top Bar ======= -->
    <div id="topbar" class="d-flex align-items-center fixed-top d-none">
        <div class="container d-flex justify-content-between">
            ...
            <div class="d-none d-lg-flex social-links align-items-center">
                <div class="wrap">
                    {!! Form::open(['route' => 'search-result.index', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="search">
                ...
                <a href="https://www.instagram.com/bapenda_jateng/" class="instagram"><i
    ...
    <header class="fixed-top">
        <div  style="background:#0156C6;">
            <div class="container">
                <div class="row" style="margin-bottom: 0;">
                    <div class="col-md-8 col-lg-8" style="">
                        <div class="runtext-container">
                            <div class="main-runtext" style="margin-top:7px">
                                <marquee direction="" scrollamount="6" onmouseover="this.stop();" onmouseout="this.start();">
                                    <div class="holder">
                                        <div class="text-container" style="color:#fff">Selamat datang di website Badan Pengelola Pendapatan Daerah Provinsi Jawa Tengah</div>
                                    </div>
                                </marquee>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="runtext-container">
                            <div class="main-runtext" style="margin-top:7px">
                                <div class="text-container text-end" style="color:#fff">bapenda@jatengprov.go.id | (024) 3515514 </div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="header" >
        <div class="container d-flex justify-content-between align-items-center" style="gap:35px;">

            <!-- <h1 class="logo me-auto"><a href="/">BAPENDA Prov. Jateng</a></h1> -->
            <!-- Uncomment below if you prefer to use an image logo -->
            <a href="{{ env('APP_URL') }}" class="logo me-auto d-flex">
                <img src="{{ url('portal/img/jateng.png') }}"
                    alt="" class="img-fluid">
                <img src="{{ url('portal/img/logo-bapenda.png') }}"
            ...
            <div style="cursor:pointer">
                <i class="fa fa-search" id="openSearch" class=" font-weight-bold"></i>
            </div>
