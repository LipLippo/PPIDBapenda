            ...
            <ul vocab="http://schema.org/" typeof="BreadcrumbList" class="breadcrumb" id="bc1">
                ...
                <li property="itemListElement" typeof="ListItem" >
                    {{-- <a property="item" typeof="WebPage" href="{{url('')}}/category/{{strtolower(str_replace(' ','-',strtolower(str_replace(' ','-',@$cat[0]))))}}"> --}}
                         <a property="item" typeof="WebPage" href="{{url('')}}/categorys/{{@$cat[0] }}">
        ...
        <div class="col-xs-12">
            <div class="artikel-items detail">
                ...
                <div class="artikel-waktu">
                    Diposkan &nbsp; {{@tanggal($page->tgl_publish)}} &nbsp; {{@jam(substr($page->tgl_publish,11,5))}} WIB &nbsp; Oleh : {{($page->isadmin == 2)?'Pegawai':$page->name}} &nbsp; <a href="{{url('')}}/categorys/{{@$cat[0]}}"><i class="fa fa-fw fa-tag"></i> {{@$cat[0]}}</a>
                </div>
