    ...
    <div class="row layout-top-spacing">
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                   {!! Form::model($modal, ['method' => 'PATCH','route' => ['modals.update', $modal->id],'enctype'=>'multipart/form-data']) !!}
                        {{ Form::hidden('id') }}
                        ...
                        <div class="form-group mb-2 mt-0">
                            ...
                            <img width="150px" src="{{ url('packages/upload/modal/'.$modal->image) }}"/>
                        ...
                        <a class="mt-4 mb-4 btn btn-secondary" href="{{ route('modals.index') }}"> Back</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
