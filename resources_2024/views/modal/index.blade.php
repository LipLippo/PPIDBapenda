  ...
  <div class="row layout-spacing">
      ...
      <div class="col-lg-12">
          ...
          <div class="statbox widget box box-shadow">
            <a class="btn btn-success" href="{{ route('modals.create') }}"> Create New</a>
                      ...
                      <tbody id="tablecontents">
                        @foreach ($modal as $key => $al)
                            <tr  id="tr_{{$al->id}}" class="row1" data-id="{{ $al->id }}">
                                <td >{{ ++$i }}   </td>
                                <td><img src="{{ url('packages/upload/modal/'.$al->image) }}" alt="" height="70px" width="55px"></td>
                                {{-- <td></td> --}}
                                <td>
                                    @if ($al->publish == 1)
                                ...
                                <td >
                                            ...
                                            <a class="btn btn-primary btn-sm" href="{{ route('modals.edit',$al->id) }}">Edit</a>
                          ...
                          <div id="rotateleftModal{{ $al->id }}" class="modal animated rotateInDownLeft custo-rotateInDownLeft" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                     <form action="{{ route('modals.destroy',$al->id) }}" method="POST">
