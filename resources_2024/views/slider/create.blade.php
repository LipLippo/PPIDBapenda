                ...
                <div class="widget-content widget-content-area">
                   {!! Form::open(array('route' => 'sliders.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="form-group mb-2 mt-0">
                            ...
                            <input type="file" class="custom-file-input" id="customFile" name="img" value="1.png">
                        ...
                        <div class="form-group mb-4">
                            ...
                            {!! Form::hidden('user_id', $iduser, array('placeholder' => 'Masukkan','class' => 'form-control')) !!}
                        </div>
                        ...
                        <a class="mt-4 mb-4 btn btn-secondary" href="{{ route('sliders.index') }}"> Back</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
