  ...
  <div class="row layout-spacing">
      ...
      <div class="col-lg-12">
          ...
          <div class="statbox widget box box-shadow">
            <a class="btn btn-success" href="{{ route('sotk_pejabat.create') }}"> Create New</a>
              <div class="widget-content widget-content-area">
                        ...
                        @foreach ($pejabat as $key => $al)
                            <tr  id="tr_{{$al->id}}" class="row1" data-id="{{ $al->id }}">
                                ...
                                <td >
                                            ...
                                            <a class="btn btn-primary btn-sm" href="{{ route('sotk_pejabat.edit',$al->id) }}">Edit</a>
                          ...
                          <div id="rotateleftModal{{ $al->id }}" class="modal animated rotateInDownLeft custo-rotateInDownLeft" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                     <form action="{{ route('sotk_pejabat.destroy',$al->id) }}" method="POST">
                  ...
                  {{-- {!! $data->render() !!} --}}
                  <button style="display: none" id="btndlt" class="btn btn-warning btn-sm delete_all" data-url="{{ url('pejabats-multidel') }}">Hapus data</button>
              </div>
          </div>
      </div>
  </div>
