    ...
    <div class="row layout-top-spacing">
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                   {!! Form::open(array('route' => 'pejabatppid.store','method'=>'POST' ,'enctype'=>'multipart/form-data')) !!}
                        ...
                        <a class="mt-0 mb-0 btn btn-secondary" href="{{ route('pejabatppid.index') }}"> Back</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
