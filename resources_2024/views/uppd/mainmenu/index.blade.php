        ...
        <div class="col-lg-12">
          ...
          <div class="statbox widget box box-shadow">
            @can('mod-menuutamauppd-create')
                <a class="btn btn-success" href="{{ route('uppdmain.create') }}"> Create New Menu</a><br><br>
            @endcan
              <div class="widget-content widget-content-area">
                  <table id="zero-config" class="table style-2  table-hover responsive table-bordered ">
                        ...
                        @foreach ($main as $m)
                          <tr id="tr_{{$m->id}}" class="row1" data-id="{{ $m->id }} " >
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-sm" href="{{ route('uppdmain.edit',$m->id) }}">Edit</a>
                                    @endcan
                            ...
                            <div id="rotateleftModal{{ $m->id }}" class="modal animated rotateInDownLeft custo-rotateInDownLeft" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                     <form action="{{ route('uppdmain.destroy',$m->id) }}" method="POST">
                    ...
                    {{-- {!! $posts->links() !!} --}}
                    <button style="display: none" id="btndlt" class="btn btn-warning btn-sm delete_all" data-url="{{ url('mainuppd-multidel') }}">Hapus data</button>
                </div>
            </div>
        </div>
    </div>
