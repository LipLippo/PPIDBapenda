                ...
                <div class="widget-content widget-content-area">
                   {!! Form::model($album, ['method' => 'PATCH','route' => ['album.update', $album->id]]) !!}
                        ...
                        <div class="form-group mb-4">
                            ...
                            {!! Form::text('album', null, array('placeholder' => 'Username','class' => 'form-control')) !!}
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control  basic" name="headline" required>
                                <option  {{ $album->headline == 1 ? 'selected' : '' }} value="1">Headline</option>
                                <option {{ $album->headline == 0 ? 'selected' : '' }} value="0">Tidak Headline</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control  basic" name="flag" required>
                                <option {{ $album->flag == 1 ? 'selected' : '' }} value="1">Publish</option>
                                <option {{ $album->flag == 0 ? 'selected' : '' }} value="0">Tidak Publish</option>
                            </select>
                        </div>
