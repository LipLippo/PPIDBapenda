    ...
    <div class="row layout-top-spacing">
        <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                @endif
                {!! Form::model($main, ['method' => 'PATCH','route' => ['mainppid.update', $main->id],'enctype'=>'multipart/form-data']) !!}
                    <div class="row">
                                    ...
                                    {{ Form::hidden('id') }}
                                     ...
                                     {{ Form::hidden('role_id', $role_id, array('class'=> 'form-control')) }}
                                       <div class="form-row mb-2">
                                        ...
                                        <div class="form-row mb-0 mt-0">
                                            <div class="form-group mb-0 col-md-12 mt-0">
                                                ...
                                                <select class="form-control  basic" name="jenis_konten" id="jeniskonten" required>
                                                    ...
                                                    <option  value="2" {{ $main->jenis_konten == 2 ? 'selected' : '' }}>Link</option>
                                                    <option value="3" {{ $main->jenis_konten == 3 ? 'selected' : '' }}>Pdf</option>
                                        ...
                                        <a class="mt-4 mb-4 btn btn-secondary" href="{{ route('mainppid.index') }}"> Back</a>
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
