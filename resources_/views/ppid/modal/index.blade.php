  ...
  <div class="row layout-spacing">
      ...
      <div class="col-lg-12">
          ...
          <div class="statbox widget box box-shadow">
            <a class="btn btn-success" href="{{ route('ppidmodal.create') }}"> Create New</a>
              <div class="widget-content widget-content-area">
                  <table id="zero-config" class="table style-3  table-hover">
                      ...
                      <tbody id="tablecontents">
                        @foreach ($modal as $key => $al)
                            <tr  id="tr_{{$al->id}}" class="row1" data-id="{{ $al->id }}">
                                <td >{{ ++$i }}   </td>
                                <td><img src="{{ url('packages/upload/ppid/modal/'.$al->image) }}" alt="" height="70px" width="55px"></td>
                                {{-- <td></td> --}}
                                <td>
                                    @if ($al->publish == 1)
                                ...
                                <td >
                                    ...
                                    <a class="btn btn-primary btn-sm" href="{{ route('ppidmodal.edit',$al->id) }}">Edit</a>
                          ...
                          <div id="rotateleftModal{{ $al->id }}" class="modal animated rotateInDownLeft custo-rotateInDownLeft" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                     <form action="{{ route('ppidmodal.destroy',$al->id) }}" method="POST">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <p class="modal-text">Anda yakin ingin menghapus {{ $al->id }}</p>
                                            </div>
                  ...
                  {{-- {!! $data->render() !!} --}}
              <button style="display: none" id="btndlt" class="btn btn-warning btn-sm delete_all" data-url="{{ url('sejarahs-multidel') }}">Hapus data</button>
              </div>
          </div>
      </div>
  </div>
