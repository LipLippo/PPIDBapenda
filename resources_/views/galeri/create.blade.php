    ...
    <div class="row layout-top-spacing">
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                   {!! Form::open(array('route' => 'galeris.store','method'=>'POST' ,'enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="form-group mb-0">
                            ...
                            <select name="id_album" id="album" class="form-control basic">
                                ...
                                @foreach ($album as $a)
                                <option value="{{ $a->id }}">{{ $a->album }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mb-2 mt-0">
                         ...
                         <div class="form-group mb-4 mt-4">
                            ...
                            {!! Form::text('keterangan', null, array('placeholder' => 'Masukkan Keterangan','class' => 'form-control', 'required')) !!}
                        </div>
                        <div class="form-group mb-2 mt-0">
                        ...
                        <a class="mt-0 mb-0 btn btn-secondary" href="{{ route('galeris.index') }}"> Back</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
