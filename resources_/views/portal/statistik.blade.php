...
{{View::make('portal.header',array('judul'=> 'Statistik Prizinan','type' => 'pages'))}}
<br>
<br>
<br>
<br>
...
<div class="container">
    <div class="row">
            ...
            <ul vocab="http://schema.org/" typeof="BreadcrumbList" class="breadcrumb" id="bc1">
                ...
                <li property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" href="#">
                        <span property="name">Detail Statistik</span></a>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-12">
            <?php
                $rschart = DB::table('statistik_perizinan as a')->leftJoin('users as b', 'a.user_id', '=', 'b.id')->select('a.*', 'b.name')->where('a.id', $cat)->first();
            ...
            <div class="artikel-items detail">
                <div class="artikel-waktu">                    
                    Diposkan &nbsp; {{@tanggal($rschart->created_at)}} &nbsp; {{@jam(substr($rschart->created_at,11,5))}} WIB &nbsp; Oleh : {{@$rschart->name}} &nbsp; <a href="{{url('')}}/statistik_perizinan"><i class="fa fa-fw fa-tag"></i> Statistik</a>
                </div>
                <h1 class="artikel-judul detail">Statistik</h1>
                <div class="artikel-isi">
                    ...
                    <table class="table table-hover" id='datatable' style="display: nones">
                        <thead>
                            <tr class="bg-primary">
                                <th width="90%">SEKTOR</th>
                                <th class="text-right" width="10%">TOTAL PERIZINAN</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php for($i = 0; $i < $n; $i++){?>
